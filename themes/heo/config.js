const CONFIG = {
  ...
  NOTICE_BAR: [
    ...
    { title: '欢迎访问我的代码仓库', url: 'https://docs.tangly1024.com' }
  ],
  ...
  HERO_CATEGORY_2: { title: '学习思考', url: '/tag/学习思考' },
  HERO_CATEGORY_3: { title: '碎片杂文', url: '/tag/碎片杂文' },
  ...
  SOCIAL_CARD_TITLE_1: '音乐频道',
  SOCIAL_CARD_TITLE_2: '分享我喜欢的音乐',
  SOCIAL_CARD_TITLE_3: '用音乐感染人心',
